...
The uncompressed data is in [BSON format](https://en.wikipedia.org/wiki/BSON) and follows the information detailed on the [chunk format](./Chunk_format/index.md) article.
